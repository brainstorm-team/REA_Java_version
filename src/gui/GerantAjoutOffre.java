 ...
 * @author jemacom
 */
public class GerantAjoutOffre extends javax.swing.JFrame {

    /**
     * Creates new form AjoutOffre
     */
    
    public GerantAjoutOffre() {
        initComponents();
...
//        offre.setIdClient(Util.client.getId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerantAjoutOffre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
