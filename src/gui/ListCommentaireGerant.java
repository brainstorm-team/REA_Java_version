 ...
 * @author jemacom
 */
public class ListCommentaireGerant extends javax.swing.JFrame {

    /**
     * Creates new form Acceuil
     */
    public ListCommentaireGerant() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Liste des commentaires :");
...
//        System.exit(WIDTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListCommentaireGerant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try{
                    ...
                    new ListCommentaireGerant().setVisible(true);
                } catch (UnsupportedLookAndFeelException ex) {
                    Logger.getLogger(ListCommentaireGerant.class.getName()).log(Level.SEVERE, null, ex);
