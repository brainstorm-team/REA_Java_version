 ...
 * @author jemacom
 */
public class ListCommentairesClient extends javax.swing.JFrame {

    /**
     * Creates new form Acceuil
     */
    public ListCommentairesClient() {
        initComponents();
...
//        System.exit(WIDTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListCommentairesClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new ListCommentairesClient().setVisible(true);
                } catch (UnsupportedLookAndFeelException ex) {
                    Logger.getLogger(ListCommentairesClient.class.getName()).log(Level.SEVERE, null, ex);
