 ...
 * @author jemacom
 */
public class ListMessagesClient extends javax.swing.JFrame {

    /**
     * Creates new form Acceuil
     */
    public ListMessagesClient() {
        initComponents();
...
//        System.exit(WIDTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListMessagesClient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    new ListMessagesClient().setVisible(true);
                } catch (UnsupportedLookAndFeelException ex) {
                    Logger.getLogger(ListMessagesClient.class.getName()).log(Level.SEVERE, null, ex);
